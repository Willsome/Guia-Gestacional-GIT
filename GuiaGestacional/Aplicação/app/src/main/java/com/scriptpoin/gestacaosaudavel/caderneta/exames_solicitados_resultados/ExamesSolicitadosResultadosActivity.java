...
public class ExamesSolicitadosResultadosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        esLlExamesSolicitados = findViewById(R.id.esLlExamesSolicitados);

        // CAMPOS DA CONSULTA SOLICITAÇÃO/RESULTADO
        EditText esEtConsultaSolicitacao = findViewById(R.id.esEtConsultaSolicitacao);
        ...
        viewsDosExamesSelecionados = new ArrayList<>();
        ...
        Button esBtSalvar = findViewById(R.id.esBtSalvar);
    ...
    public void adicionaViewsDeExamesSolicitados(final ArrayList<Exame> exames, final ArrayList<Exame> examesSolicitados, int j) {
        ...
        for (int i = 0; i < exames.size(); i++) {
            ...
            LinearLayout esLlResultado = view.findViewById(R.id.esLlResultado);
            esLlResultado.setVisibility(View.GONE);

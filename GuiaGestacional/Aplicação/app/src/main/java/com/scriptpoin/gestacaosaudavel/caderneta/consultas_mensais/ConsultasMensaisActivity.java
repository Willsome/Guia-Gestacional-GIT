...
public class ConsultasMensaisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConsultasMensais consultaMensal = (ConsultasMensais) intent.getSerializableExtra("consultaMensal");

        // SPINNER POSICAO FETAL
        Spinner cmSpPosicaoFetal = findViewById(R.id.cmSpPosicaoFetal);
        ...
        Spinner cmSpTipoProfissional = findViewById(R.id.cmSpTipoProfissional);
        ...
        Button cmBtSalvar = findViewById(R.id.cmBtSalvar);
    ...
    private void pegaDataConsulta(final ConsultasMensais consultaMensal) {
        ...
        cmTvFormDataConsulta = findViewById(R.id.cmTvFormDataConsulta);

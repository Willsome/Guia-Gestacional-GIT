...
public class DadosObstetricosHelper {
    ...
    public DadosObstetricosHelper(Activity activity, int i, View view) {
        ...
        if (i == 1) {
            doTvDpDum = activity.findViewById(R.id.doTvDpDum);
            doTvDpDpp = activity.findViewById(R.id.doTvDpDpp);
        } else if (i == 2) {
            doTvDum = view.findViewById(R.id.doTvDum);
            doTvDpp = view.findViewById(R.id.doTvDpp);
        }

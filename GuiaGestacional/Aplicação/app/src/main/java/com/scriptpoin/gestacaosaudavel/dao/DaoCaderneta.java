...
public class DaoCaderneta extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String criaTabelaUltrassonografia =
                "CREATE TABLE IF NOT EXISTS Ultrassonografia(" +
                        ...
                        "numeroConsultaResultado INTEGER," +
                        "data DATE," +
                        "igDumSemanas INTEGER NOT NULL," +
                        "igDumDias INTEGER NOT NULL," +
                        "igUsgSemanas INTEGER NOT NULL," +
                        "igUsgDias INTEGER NOT NULL," +
                        "pesoFetal REAL," +
                        "placenta TEXT," +
    ...
    @NonNull
    private ContentValues getContentValuesDadosPessoais(DadosPessoais dadosPessoais) {
    ...
    @NonNull
    private ContentValues getContentValuesDadosObstetricos(DadosObstetricos dadosObstetricos) {
        ContentValues contentValues = new ContentValues();
    ...
    @NonNull
    private ContentValues getContentValuesExamesSolicitadosResultados(ExamesSolicitadosResultados es) {
        ContentValues contentValues = new ContentValues();
    ...
    public ArrayList<ExamesSolicitadosResultados> pegaExameSolicitadosResultado(int numeroDaConsulta, Context context) {
    ...
    private Exame pegaExamePeloId(Long id) {
    ...
    public ArrayList<ExamesSolicitadosResultados> pegaExamesSolicitadosResultados(DaoCaderneta dao) {
    ...
    public ArrayList<String> pegaQuantExamesSolicitadosResultados() {
        ...
        String sql = "SELECT DISTINCT numeroConsultaSolicitacao FROM ExamesSolicitadosResultados ORDER BY numeroConsultaSolicitacao ASC";
    ...
    @NonNull
    private ContentValues getContentValuesUltrassonografia(Ultrassonografia ultrassonografia) {
        ContentValues contentValues = new ContentValues();
...
//            contentValues.put("igUsg", "");
            contentValues.put("igDumSemanas", "");
            contentValues.put("igDumDias", "");
            contentValues.put("igUsgSemanas", "");
            contentValues.put("igUsgDias", "");
...
//            contentValues.put("igUsg", ultrassonografia.getIgUsg().getTimeInMillis());
            contentValues.put("igDumSemanas", ultrassonografia.getIgDumSemanas());
            contentValues.put("igDumDias", ultrassonografia.getIgDumDias());
            contentValues.put("igUsgSemanas", ultrassonografia.getIgUsgSemanas());
            contentValues.put("igUsgDias", ultrassonografia.getIgUsgDias());
    ...
    public ArrayList<Ultrassonografia> pegaUltrassonografias() {

        SQLiteDatabase db = getReadableDatabase();

        String sql = "SELECT * FROM Ultrassonografia";

        ArrayList<Ultrassonografia> ultrassonografias = new ArrayList<>();
...
//            dataIgDum.setTimeInMillis(c.getLong(c.getColumnIndex("igDum")));
            ultrassonografia.setIgDumSemanas(c.getInt(c.getColumnIndex("igDumSemanas")));
            ultrassonografia.setIgDumDias(c.getInt(c.getColumnIndex("igDumDias")));

//            Calendar dataIgUsg = Calendar.getInstance();
//            dataIgUsg.setTimeInMillis(c.getLong(c.getColumnIndex("igUsg")));
            ultrassonografia.setIgUsgSemanas(c.getInt(c.getColumnIndex("igUsgSemanas")));
            ultrassonografia.setIgUsgDias(c.getInt(c.getColumnIndex("igUsgDias")));
            ...
            ultrassonografias.add(ultrassonografia);
        }
        c.close();
...
//            dataIgUsg.setTimeInMillis(c.getLong(c.getColumnIndex("igUsg")));
    ...
    @NonNull
    private ContentValues getContentValuesConsultasMensais(ConsultasMensais consultasMensais) {
        ContentValues contentValues = new ContentValues();
    ...
    public ConsultasMensais pegaConsultaMensal(int numeroDaConsulta) {
    ...
    public ArrayList<ConsultasMensais> pegaConsultasMensais() {

        SQLiteDatabase db = getReadableDatabase();

        String sql = "SELECT * FROM ConsultasMensais";

        ArrayList<ConsultasMensais> consultasMensais = new ArrayList<>();

        Cursor c = db.rawQuery(sql, null);
        while (c.moveToNext()) {
            ConsultasMensais consultaMensal = new ConsultasMensais();
            consultaMensal.setNumeroConsulta(c.getLong(c.getColumnIndex("numeroConsulta")));

            Calendar dataConsulta = Calendar.getInstance();
            dataConsulta.setTimeInMillis(c.getLong(c.getColumnIndex("dataConsulta")));
            consultaMensal.setDataConsulta(dataConsulta);

            consultaMensal.setQueixa(c.getString(c.getColumnIndex("queixa")));
            consultaMensal.setIg(c.getDouble(c.getColumnIndex("ig")));
            consultaMensal.setPeso(c.getDouble(c.getColumnIndex("peso")));
            consultaMensal.setImc(c.getDouble(c.getColumnIndex("imc")));
            consultaMensal.setEdema(c.getString(c.getColumnIndex("edema")));
            consultaMensal.setPaI(c.getDouble(c.getColumnIndex("paI")));
            consultaMensal.setPaII(c.getDouble(c.getColumnIndex("paII")));
            consultaMensal.setAlturaUterina(c.getString(c.getColumnIndex("alturaUterina")));
            consultaMensal.setPosicaoFetal(c.getString(c.getColumnIndex("posicaoFetal")));
            consultaMensal.setBcf(c.getInt(c.getColumnIndex("bcf")));
            consultaMensal.setMovFetal(c.getString(c.getColumnIndex("movFetal")));
            consultaMensal.setTipoProfissional(c.getString(c.getColumnIndex("tipoProfissional")));
            consultaMensal.setNomeDoProfissional(c.getString(c.getColumnIndex("nomeDoProfissional")));

            consultasMensais.add(consultaMensal);
        }
        c.close();
